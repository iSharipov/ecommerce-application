    ...
    public void getItems() throws Exception {
        mvc.perform(
                get(new URI("/api/item"))
                        .header("Authorization", "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJ1c2VybmFtZSIsImV4cCI6MTU2NDUyOTAxMCwiaWF0IjoxNTY0NTExMDEwfQ.1a0DmsSwCB-obOoTPq4QoQBT8frS0fLFTfbV8RCBzsQHzPqm-ViK9dpwAu0-QOH69WRrryyUbgfzp3EgdEphgA")
